...
export class CommentController {
   ...
   */
  public updateComment = asyncHandler(async (req: Request, res: Response): Promise<void> => {
   ...
   */
  public addReply = asyncHandler(async (req: Request, res: Response): Promise<void> => {
    const { commentId } = req.params;
   ...
   */
  public resolveComment = asyncHandler(async (req: Request, res: Response): Promise<void> => {
    const { commentId } = req.params;
   ...
   */
  public getCommentAnalytics = asyncHandler(async (req: Request, res: Response): Promise<void> => {
    const { workflowId } = req.params;
