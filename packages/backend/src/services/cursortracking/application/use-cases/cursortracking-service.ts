...
// Consolidated cursortracking service using shared base classes
// Replaces 8 individual CRUD use-case files

@injectable()
export class CursortrackingService {
  constructor(
    @inject('CursortrackingRepository')
  ...
  static getInstance() {
    ...
    return new CursortrackingService(/* inject repository */);
  }
}
