...
// Consolidated operationaltransform service using shared base classes
// Replaces 5 individual CRUD use-case files

@injectable()
export class OperationaltransformService {
  constructor(
    @inject('OperationaltransformRepository')
  ...
  static getInstance() {
    ...
    return new OperationaltransformService(/* inject repository */);
  }
}

export default OperationaltransformService;
