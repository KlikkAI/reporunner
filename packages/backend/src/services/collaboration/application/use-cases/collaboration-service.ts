...
// Consolidated collaboration service using shared base classes
// Replaces 10 individual CRUD use-case files
...
export class CollaborationService {
  ...
  static getInstance() {
    ...
    return new CollaborationService(/* inject repository */);
  }
}
