...
// Consolidated debugging service using shared base classes
// Replaces 6 individual CRUD use-case files

@injectable()
export class DebuggingService {
  constructor(
    @inject('DebuggingRepository')
  ...
  static getInstance() {
    ...
    return new DebuggingService(/* inject repository */);
  }
}
