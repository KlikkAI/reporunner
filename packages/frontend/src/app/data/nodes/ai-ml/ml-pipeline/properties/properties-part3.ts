...
,
{
        ...
        options: [
            ...
            displayOptions: 
                enabled: [true],,,
            options: [name: 'Feast', value: 'feast' ,name: 'Tecton', value: 'tecton' ,name: 'AWS Feature Store', value: 'aws_feature_store' ,name: 'Google Feature Store', value: 'gcp_feature_store' ,name: 'Azure Feature Store', value: 'azure_feature_store' ,
            ],,
