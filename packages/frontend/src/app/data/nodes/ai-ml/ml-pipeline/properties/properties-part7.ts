...
// Experiment Tracking Section
{
    ...
    options: [
        ...
        displayOptions: 
            enabled: [true],,,
        options: [name: 'MLflow', value: 'mlflow' ,name: 'Weights & Biases', value: 'wandb' ,name: 'Neptune', value: 'neptune' ,name: 'Comet ML', value: 'comet' ,name: 'TensorBoard', value: 'tensorboard' ,name: 'Azure ML Experiments', value: 'azure_ml' ,name: 'AWS SageMaker Experiments', value: 'sagemaker' ,
        ],
