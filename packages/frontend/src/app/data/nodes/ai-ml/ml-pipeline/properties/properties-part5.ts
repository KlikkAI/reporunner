...
// Deployment Configuration Section
{
    ...
    options: [
        ...
        displayOptions: 
            autoDeploy: [true],,,
        options: [name: 'Kubernetes', value: 'kubernetes' ,name: 'Docker', value: 'docker' ,name: 'AWS SageMaker', value: 'sagemaker' ,name: 'Google Cloud Run', value: 'cloud_run' ,name: 'Azure Container Instances', value: 'azure_aci' ,name: 'Serverless (Lambda)', value: 'serverless' ,name: 'Edge Deployment', value: 'edge' ,
        ],
        ...
        displayOptions: 
            autoDeploy: [true],,,
        options: [name: 'Blue-Green', value: 'blue_green' ,name: 'Canary', value: 'canary' ,name: 'Rolling Update', value: 'rolling' ,name: 'Shadow Deployment', value: 'shadow' ,name: 'A/B Testing', value: 'ab_testing' ,
        ],
