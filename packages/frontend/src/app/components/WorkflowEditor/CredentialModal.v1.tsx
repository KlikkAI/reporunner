...
const _AIProviderForm: React.FC<{
  ...
  return (
    <>
      <Alert
        type="info"
        title={credentialTypeDef.name}
        message={credentialTypeDef.description}
      />
  ...
  return (
    <>
      ...
      <div>
        ...
        <p className="text-xs text-gray-400 mt-1">
          In {credentialType}, use the URL above when prompted to enter an OAuth callback or redirect URL
        </p>
      </div>
