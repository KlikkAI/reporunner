      ...
      <div className="container mx-auto px-6">
        ...
        <div className="text-center mb-16">
          ...
          <p className="text-xl text-gray-600 max-w-3xl mx-auto mb-8">
            ...
            Enterprise-grade features at every level.
          </p>
            ...
            <table className="w-full">
              <thead>
                <tr className="border-b border-gray-200">
                  <th className="text-left py-4 pr-6 font-semibold text-gray-900">
                    Features
                  </th>
        ...
        <div className="mt-16 bg-white rounded-2xl border border-gray-200 p-8">
          ...
          <div className="mt-6 text-center">
            <p className="text-sm text-gray-600">
              💡 <strong>Reporunner advantage:</strong> Enterprise features at
              mid-market pricing with complete self-hosting control
            </p>
          </div>
        </div>
        ...
        <div className="mt-16 text-center">
          <div className="bg-gradient-to-r from-blue-600 to-purple-600 rounded-2xl p-8 text-white">
            ...
            <p className="text-blue-100 mb-6 max-w-2xl mx-auto">
              We offer custom deployment options, dedicated support, and
