...
const UserManagementPanel: React.FC<UserManagementPanelProps> = ({ className }) => {
  ...
  const userColumns = [
    ...
    },
    {
      ...
      key: 'role',
      render: (record: User) => (
        <Tag color={getRoleColor(record.role.id)}>
          {record.role.name}
        </Tag>
      ),
    },
  ...
  const apiKeyColumns = [
    {
      ...
      render: (record: APIKey) => (
        <div>
          <div className="text-white font-medium">{record.name}</div>
          <div className="text-gray-400 text-xs">{record.metadata.description}</div>
        </div>
      ),
    },
    {
    ...
    <div className="space-y-4">
      ...
      <Card size="small" className="bg-gray-800 border-gray-600">
        <div className="flex items-center justify-between mb-4">
          <Title level={5} className="text-white mb-0">Users</Title>
          <Space>
            <Search
  ...
  const renderAPIKeysTab = () => (
    <div className="space-y-4">
      <Card size="small" className="bg-gray-800 border-gray-600">
        <div className="flex items-center justify-between mb-4">
          <Title level={5} className="text-white mb-0">API Keys</Title>
          <Button
            type="primary"
            icon={<KeyOutlined />}
  ...
  const renderInvitationsTab = () => (
    <div className="space-y-4">
      <Card size="small" className="bg-gray-800 border-gray-600">
        <div className="flex items-center justify-between mb-4">
          <Title level={5} className="text-white mb-0">Pending Invitations</Title>
          <Button
            type="primary"
            icon={<MailOutlined />}
            onClick={() => setIsInviteModalOpen(true)}
  ...
  const renderSSOTab = () => (
    <div className="space-y-4">
      <Card size="small" className="bg-gray-800 border-gray-600">
        <Title level={5} className="text-white mb-4">SSO Providers</Title>
    ...
    <div className={cn('h-full bg-gray-900', className)}>
      <div className="p-4 border-b border-gray-700">
        <div className="flex items-center gap-2 mb-2">
          ...
          <Title level={4} className="text-white mb-0">User Management</Title>
        </div>
            ...
            },
            {
              ...
              label: (
                <span>
                  ...
                  Invitations
                  <Badge count={invitations.filter(i => i.status === 'pending').length} size="small" className="ml-2" />
                </span>
              ),
            ...
            },
            {
              ...
              label: (
                <span>
                  ...
                  SSO
                  <Badge count={ssoProviders.filter(p => p.enabled).length} size="small" className="ml-2" />
                </span>
              ),
