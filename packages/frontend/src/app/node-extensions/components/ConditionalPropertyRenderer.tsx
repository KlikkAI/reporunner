...
class DisplayOptionsEvaluator {
  ...
  constructor(nodeValues: Record<string, any>, evaluationContext?: any) {
  ...
  evaluateDisplayOptions(displayOptions: EnhancedDisplayOptions): {
    ...
    if (displayOptions.showIf && visible) {
      visible = this.evaluateAdvancedConditions(displayOptions.showIf, 'show')
    }

    if (displayOptions.hideIf && visible) {
      visible = !this.evaluateAdvancedConditions(displayOptions.hideIf, 'hide')
    }
...
> = ({
  ...
  const evaluator = useMemo(
    () => new DisplayOptionsEvaluator(nodeValues, evaluationContext),
    [nodeValues, evaluationContext]
  )
...
export const displayOptionsUtils = {
  evaluateDisplayOptions: (
    ...
    const evaluator = new DisplayOptionsEvaluator(nodeValues, evaluationContext)
