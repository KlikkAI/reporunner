      ...
      case "numberValue":
        return (
          <Input
            ...
            value={assignment.value ?? ""}
            onChange={(e) =>
              handleFieldChange("value", Number(e.target.value) || 0)
            }
            disabled={disabled}
          />
        );
...
const TransformAssignmentCollection: React.FC<
  TransformAssignmentCollectionProps
> = ({ assignments, onChange, inputData, disabled }) => {
