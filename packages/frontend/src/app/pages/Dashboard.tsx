...
const Dashboard: React.FC = () => {
  ...
  const { createNewWorkflow, deleteWorkflow, isLoading, shouldRefreshDashboard, setShouldRefreshDashboard } =
        ...
        <div className="flex items-center justify-between">
          <div className="flex-1">
            <div className="flex items-center space-x-3">
              ...
              >
                {(workflow.status === 'active' || workflow.isActive) ? 'active' : workflow.status || 'inactive'}
              </span>
            </div>
            ...
            <div className="flex items-center mt-2 space-x-4">
              ...
              <span className="text-xs text-gray-500">
                Updated {workflow.updatedAt ? new Date(workflow.updatedAt).toLocaleDateString() : 'N/A'}
              </span>
              {workflow.lastRun && (
                <span className="text-xs text-gray-500">
          ...
          <div key={stat.name} className="bg-white p-6 rounded-lg shadow">
            <div className="flex items-center">
              ...
              <div>
                ...
                {!statsLoading && stats && stat.name === 'Total Executions' && stats.totalExecutions === 0 && (
