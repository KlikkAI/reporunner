...
export const SelfHosted: React.FC = () => {
    ...
    manual: {
      ...
      steps: [
        ...
        },
        {
          ...
          command:
            "git clone https://github.com/reporunner/reporunner.git && cd reporunner",
        },
        {
  ...
  const features = [
    ...
    },
    {
      ...
      description:
        "Multi-region deployment support with data residency compliance.",
      icon: Globe,
        ...
        <div className="container mx-auto px-6 relative z-10">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <p className="text-xl text-slate-200 mb-8 max-w-3xl mx-auto leading-relaxed">
              Complete control over your data and infrastructure. Deploy
              Reporunner anywhere - cloud, on-premises, or air-gapped
        ...
        <div className="container mx-auto px-6">
          <div className="max-w-4xl mx-auto text-center mb-12">
            ...
            <p className="text-xl text-gray-600">
              Choose the deployment method that fits your infrastructure and
              requirements
            </p>
          </div>
          ...
          <div className="max-w-4xl mx-auto">
            <div className="bg-gray-900 rounded-xl p-6">
              ...
              <div className="space-y-6">
                {commands[activeDeployment as keyof typeof commands].steps.map(
                  (step, index) => (
        ...
        <div className="container mx-auto px-6">
          <div className="max-w-6xl mx-auto">
            <div className="text-center mb-12">
              ...
              <p className="text-xl text-gray-600">
                Hardware and software requirements for different deployment
                scenarios
              </p>
            </div>
      ...
      <section className="py-16 bg-white">
        <div className="container mx-auto px-6">
          <div className="max-w-4xl mx-auto text-center mb-12">
            ...
            <p className="text-xl text-gray-600">
              Complete control, security, and customization for your workflow
              automation needs
            </p>
          </div>
      ...
      <section className="py-16 bg-gray-50">
        <div className="container mx-auto px-6">
          <div className="max-w-4xl mx-auto text-center mb-12">
            ...
            <p className="text-xl text-gray-600">
              Seamlessly migrate from existing workflow platforms to your
              self-hosted Reporunner
            </p>
          </div>
              ...
              <div className="space-y-6">
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600 text-sm">
                      Automated workflow import from popular platforms with
                ...
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600 text-sm">
                      Automatic mapping of data structures and field
                      transformations
                    </p>
                  </div>
                </div>
                ...
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600 text-sm">
                      Expert migration assistance for complex workflows and
                      custom integrations
                    </p>
                  </div>
                </div>
      ...
      <section className="py-16 bg-gradient-to-r from-blue-600 to-purple-600 text-white">
        <div className="container mx-auto px-6 text-center">
          ...
          <p className="text-xl mb-8 max-w-2xl mx-auto opacity-90">
            Start your self-hosted journey today. Complete data sovereignty,
            enterprise security, and unlimited scalability await.
          </p>
