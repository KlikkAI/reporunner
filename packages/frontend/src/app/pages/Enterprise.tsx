  ...
  const enterpriseFeatures = {
    security: [
      ...
      },
      {
        ...
        description:
          "Comprehensive audit trails for all actions, workflows, and data access",
        icon: FileText,
        benefits: [
          "Tamper-proof logs",
          "Real-time alerts",
      ...
      },
      {
        ...
        description:
          "Granular permissions with custom roles and resource-level access control",
        icon: Users,
        benefits: [
    ...
    deployment: [
      {
        ...
        description:
          "Complete offline deployment with no external dependencies",
        icon: Cloud,
      ...
      },
      {
        ...
        description:
          "Deploy across AWS, Azure, GCP, or on-premises infrastructure",
        icon: Globe,
        benefits: [
          "Vendor flexibility",
          "Disaster recovery",
      ...
      },
      {
        ...
        description:
          "Kubernetes-native deployment with automatic scaling and load balancing",
        icon: TrendingUp,
    ...
    governance: [
      {
        ...
        description:
          "Approval workflows, version control, and deployment pipelines",
        icon: Settings,
        benefits: [
          "Change management",
          "Version history",
      ...
      },
      {
        ...
        description:
          "Pre-built compliance templates for SOC2, GDPR, HIPAA, and more",
        icon: Award,
      ...
      },
      {
        ...
        description:
          "Advanced analytics and reporting for workflows and resource utilization",
        icon: BarChart3,
        benefits: [
          "Cost optimization",
  ...
  const useCases = [
    {
      ...
      description:
        "Automate compliance reporting, fraud detection, and customer onboarding",
      icon: Building,
      challenges: [
    ...
    },
    {
      title: "Healthcare",
      description:
        "HIPAA-compliant patient data processing and clinical workflow automation",
      icon: Shield,
    ...
    },
    {
      title: "Government",
      description:
        "Secure data processing, inter-agency workflows, and citizen services",
      icon: Lock,
      challenges: ["Security clearances", "Air-gap deployment", "Compliance"],
      solutions: ["FedRAMP ready", "Air-gap support", "Government cloud"],
      results:
        "Accelerated digital transformation, improved citizen experience",
    },
  ];
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
              <div>
                ...
                <p className="text-xl text-slate-200 mb-8 leading-relaxed">
                  Built for the most demanding enterprise requirements. Complete
                  security, compliance, and scalability with the power of
        ...
        <div className="container mx-auto px-6">
          <div className="max-w-4xl mx-auto text-center mb-12">
            ...
            <p className="text-xl text-gray-600">
              Everything your enterprise needs for secure, scalable workflow
              automation
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            {enterpriseFeatures[
              activeTab as keyof typeof enterpriseFeatures
            ]?.map((feature, index) => {
      ...
      <section className="py-16 bg-gradient-to-r from-blue-600 to-purple-600 text-white">
        <div className="container mx-auto px-6 text-center">
          ...
          <p className="text-xl mb-8 max-w-2xl mx-auto opacity-90">
            Join the world's most security-conscious organizations who trust
            Reporunner for their mission-critical workflows.
          </p>
