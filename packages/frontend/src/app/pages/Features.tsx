  ...
  const features = {
    "ai-powered": [
      ...
      },
      {
        ...
        description:
          "AI models that predict workflow performance and suggest optimizations.",
        icon: BarChart3,
        demo: false,
        enterprise: true,
      },
    ...
    enterprise: [
      {
        ...
        description:
          "SAML, OIDC, and Active Directory integration with role-based access control.",
        icon: Users,
        demo: false,
        enterprise: true,
      },
      {
        name: "Audit Logging",
        description:
          "Comprehensive audit trails for all workflow executions and user actions.",
        icon: Lock,
        demo: false,
        enterprise: true,
      },
      {
        ...
        description:
          "Complete tenant isolation with custom branding and domain support.",
        icon: Shield,
        demo: false,
        enterprise: true,
      },
      {
        ...
        description:
          "Real-time dashboards, alerts, and performance metrics with SLA tracking.",
        icon: BarChart3,
        demo: true,
        enterprise: true,
      },
      {
        ...
        description:
          "Automated backups, point-in-time recovery, and geographic redundancy.",
        icon: Database,
        demo: false,
        enterprise: true,
      },
      {
        ...
        description:
          "SOC2, GDPR, HIPAA compliance with automated compliance reporting.",
        icon: Shield,
        demo: false,
        enterprise: true,
      },
    ...
    "hybrid-database": [
      {
        ...
        description:
          "Fast, flexible document storage for workflows, executions, and user data.",
        icon: Database,
        demo: true,
        enterprise: false,
      },
      {
        ...
        description:
          "Dedicated AI database for embeddings, vector search, and analytics.",
        icon: Brain,
        demo: true,
        enterprise: false,
      },
      ...
      },
      {
        name: "Real-time Sync",
        description:
          "Seamless data synchronization between databases with conflict resolution.",
        icon: Zap,
        demo: false,
        enterprise: true,
      },
      {
        ...
        description:
          "Time-series analysis, pattern recognition, and predictive modeling.",
        icon: BarChart3,
        demo: true,
        enterprise: true,
      },
      {
        ...
        description:
          "Natural language search across all workflow data and documentation.",
        icon: Settings,
        demo: true,
        enterprise: false,
      },
    ...
    "self-hosted": [
      {
        ...
        description:
          "One-command deployment with production-ready configuration.",
        icon: Code2,
        demo: true,
        enterprise: false,
      },
      {
        ...
        description:
          "Enterprise-grade K8s deployment with auto-scaling and load balancing.",
        icon: Cloud,
        demo: false,
        enterprise: true,
      },
      {
        ...
        description:
          "Your data never leaves your infrastructure. Zero external dependencies.",
        icon: Lock,
        demo: false,
        enterprise: false,
      },
      {
        ...
        description:
          "Fully offline deployment capability for high-security environments.",
        icon: Shield,
        demo: false,
        enterprise: true,
      },
      {
        ...
        description:
          "Host on your domain with automatic SSL certificate management.",
        icon: Webhook,
        demo: true,
        enterprise: false,
      },
    ...
    developer: [
      ...
      },
      {
        name: "Node SDK",
        description:
          "Rich SDK for building custom nodes, integrations, and extensions.",
        icon: GitBranch,
        demo: true,
        enterprise: false,
      },
      {
        name: "REST API",
        description:
          "Complete REST API for workflow management, execution, and monitoring.",
        icon: Webhook,
        demo: true,
        enterprise: false,
      },
      ...
      },
      {
        ...
        description:
          "Instant development feedback with HMR for custom nodes and UI components.",
        icon: Zap,
        demo: true,
        enterprise: false,
      },
      {
        ...
        description:
          "Extensible plugin system with community marketplace for custom integrations.",
        icon: Users,
        demo: false,
        enterprise: true,
      },
        ...
        <div className="container mx-auto px-6 relative z-10">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <p className="text-xl text-slate-200 mb-8 max-w-3xl mx-auto leading-relaxed">
              From AI-powered automation to enterprise-grade security, discover
              the features that make Reporunner the most powerful self-hosted
              workflow platform.
            </p>
            ...
            <table className="w-full bg-white rounded-xl shadow-xl">
              <thead>
                <tr className="border-b border-gray-200">
                  ...
                  <th className="text-center p-6 font-semibold text-blue-900">
                    Reporunner
                  </th>
      ...
      <section className="py-16 bg-gradient-to-r from-blue-600 to-purple-600 text-white">
        <div className="container mx-auto px-6 text-center">
          ...
          <p className="text-xl mb-8 max-w-2xl mx-auto opacity-90">
            Start your free trial today and see how Reporunner can transform
