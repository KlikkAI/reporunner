        ...
        <div className="container mx-auto px-6 relative z-10">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <p className="text-xl text-slate-200 mb-8 max-w-3xl mx-auto leading-relaxed">
              Clear, fair terms that protect both you and Reporunner. We believe
              in transparent agreements that build trust.
            </p>
                ...
                <div className="bg-white border border-gray-200 rounded-xl p-8">
                  {activeSection === "overview" && (
                    <div className="space-y-6">
                      ...
                      <div className="prose prose-gray max-w-none">
                        <p>
                          Welcome to Reporunner. These Terms of Service
                          ("Terms") govern your use of our workflow automation
                          platform and services. By accessing or using
                          Reporunner, you agree to be bound by these Terms.
                        </p>
                        <p>
                          Reporunner is a self-hosted workflow automation
                          platform that enables you to automate business
                          processes with complete data sovereignty. Our services
                          include the core platform software, enterprise
                          features, and related support services.
                        </p>
                        <p>
                          These Terms apply to all users, including individuals,
                          businesses, and enterprise organizations. Different
                          service tiers may have additional terms as outlined in
                  ...
                  {activeSection === "acceptance" && (
                    <div className="space-y-6">
                      ...
                      <div className="prose prose-gray max-w-none">
                        <p>
                          By accessing, browsing, or using Reporunner, you
                          acknowledge that you have read, understood, and agree
                          to be bound by these Terms and all applicable laws and
                          regulations.
                        </p>
                        <p>
                          If you are using Reporunner on behalf of an
                          organization, you represent that you have the
                          authority to bind that organization to these Terms,
                          and "you" refers to both you individually and the
                          organization.
                        </p>
                        <p>
                  ...
                  {activeSection === "services" && (
                    <div className="space-y-6">
                      ...
                      <div className="prose prose-gray max-w-none">
                        <p>
                          Reporunner provides workflow automation software and
                          services, including:
                        </p>
                        <ul>
                        ...
                        <p>
                          ...
                          discontinue any part of our services at any time with
                          reasonable notice. We will not be liable for any
                  ...
                  {activeSection === "accounts" && (
                    <div className="space-y-6">
                      ...
                      <div className="prose prose-gray max-w-none">
                        <p>
                          To use certain features of Reporunner, you must create
                          an account. You are responsible for:
                        </p>
                        <ul>
                          <li>
                            Providing accurate and complete registration
                            information
                          </li>
                          <li>
                        ...
                        <p>
                          You may not share your account credentials or allow
                          others to access your account. We reserve the right to
                  ...
                  {activeSection === "usage" && (
                    <div className="space-y-6">
                      ...
                      <div className="prose prose-gray max-w-none">
                        <p>
                          You agree to use Reporunner only for lawful purposes
                          and in accordance with these Terms. You must not:
                        </p>
                        <ul>
                          <li>
                            Use the service for any illegal, harmful, or
                          ...
                          <li>
                            Spam, harass, or abuse other users or our support
                            team
                          </li>
                          <li>
                          ...
                          <li>
                            Use the service to compete with or build a similar
                            product
                          </li>
                        </ul>
                        <p>
                  ...
                  {activeSection === "privacy" && (
                    <div className="space-y-6">
                      ...
                      <div className="prose prose-gray max-w-none">
                        ...
                        <p>
                          For self-hosted deployments, you maintain complete
                          control over your data. We do not have access to your
                          workflow data, credentials, or business information
                          stored in your self-hosted instance.
                        </p>
                        <p>
                          You are responsible for ensuring your use of
                          Reporunner complies with applicable data protection
                          laws, including GDPR, CCPA, and HIPAA where
                          applicable.
                        </p>
                      </div>
                    </div>
                  ...
                  {activeSection === "payment" && (
                    <div className="space-y-6">
                      ...
                      <div className="prose prose-gray max-w-none">
                        <p>
                          Paid services are billed in advance on a monthly or
                          annual basis. By providing payment information, you
                        ...
                        <ul>
                          ...
                          <li>
                            Enterprise customers may have custom payment terms
                          </li>
                        </ul>
                        <p>
                          All payments are processed securely through our
                          payment partners. We do not store your payment
                          information.
                        </p>
                      </div>
                    </div>
                  ...
                  {activeSection === "termination" && (
                    <div className="space-y-6">
                      ...
                      <div className="prose prose-gray max-w-none">
                        ...
                        <ul>
                          <li>
                            Your access to paid features will be suspended
                          </li>
                          <li>
                          ...
                          <li>
                            Self-hosted installations continue to function
                            independently
                          </li>
                        </ul>
                        <p>
                          We may terminate or suspend your account immediately
                          if you violate these Terms or for other legitimate
                          business reasons.
                        </p>
                      </div>
                    </div>
                  ...
                  {activeSection === "liability" && (
                    <div className="space-y-6">
                      ...
                      <div className="prose prose-gray max-w-none">
                        <p>
                          To the maximum extent permitted by law, Reporunner
                        ...
                        <p>
                          Our total liability to you for any cause whatsoever
                          shall not exceed the amount paid by you to Reporunner
                  ...
                  {activeSection === "changes" && (
                    <div className="space-y-6">
                      ...
                      <div className="prose prose-gray max-w-none">
                        ...
                        <ul>
                          <li>
                            Notify you at least 30 days before the changes take
                            effect
                          </li>
                        ...
                        <p>
                          Your continued use of Reporunner after the effective
                          date constitutes acceptance of the updated Terms. If
                          you don't agree to the changes, you must stop using
                          our services.
                        </p>
                      </div>
                    </div>
              ...
              <div>
                ...
                <div className="text-orange-800 space-y-3">
                  <p>
                    ...
                    agreement. Please read them carefully and contact our legal
                    team if you have any questions.
                  </p>
                  <p>
                    For enterprise customers, additional terms may apply as
                    outlined in your Master Service Agreement or other executed
                    contracts.
                  </p>
                  <p>
                    These Terms are governed by the laws of Delaware, USA, and
      ...
      <section className="py-16 bg-gradient-to-r from-blue-600 to-purple-600 text-white">
        <div className="container mx-auto px-6 text-center">
          ...
          <p className="text-xl mb-8 max-w-2xl mx-auto opacity-90">
            By using Reporunner, you agree to these Terms of Service. Start
            building powerful workflows today.
          </p>
