        ...
        <div className="container mx-auto px-6 relative z-10">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <p className="text-xl text-slate-200 mb-8 max-w-3xl mx-auto leading-relaxed">
              Everything you need to build powerful workflows with Reporunner.
              From quick starts to advanced deployment guides.
            </p>
            ...
            {[
              {
                ...
                description:
                  "Create an intelligent chatbot using AI agents and vector search",
                duration: "45 min",
                level: "Intermediate",
                thumbnail: "🤖",
              ...
              },
              {
                ...
                description:
                  "Deploy Reporunner across AWS, Azure, and GCP with Kubernetes",
                duration: "90 min",
                level: "Advanced",
                thumbnail: "☁️",
      ...
      <section className="py-16 bg-gradient-to-r from-blue-600 to-purple-600 text-white">
        <div className="container mx-auto px-6 text-center">
          ...
          <p className="text-xl mb-8 max-w-2xl mx-auto opacity-90">
            Follow our quick start guide and build your first workflow in
            minutes
          </p>
