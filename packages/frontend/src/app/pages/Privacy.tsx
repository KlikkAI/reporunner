...
export const Privacy: React.FC = () => {
  ...
  const privacyPrinciples = [
    ...
    },
    {
      ...
      title: "Transparency",
      description:
        "We're open about what data we collect, why we collect it, and how we use it.",
    },
    {
      icon: Users,
      title: "User Control",
      description:
        "You control your data. Export, delete, or modify your information at any time.",
    },
  ];
        ...
        <div className="container mx-auto px-6 relative z-10">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <p className="text-xl text-slate-200 mb-8 max-w-3xl mx-auto leading-relaxed">
              ...
              protect your data and respect your privacy rights.
            </p>
        ...
        <div className="container mx-auto px-6">
          <div className="max-w-4xl mx-auto text-center mb-12">
            ...
            <p className="text-xl text-gray-600">
              These principles guide every decision we make about data and
              privacy
            </p>
          </div>
        ...
        <div className="container mx-auto px-6">
          <div className="max-w-6xl mx-auto">
            <div className="text-center mb-12">
              ...
              <p className="text-xl text-gray-600">
                Complete transparency about the information we collect and how
                we use it
              </p>
            </div>
              ...
              <div className="flex items-start gap-4">
                ...
                <div>
                  ...
                  <div className="text-blue-800 space-y-2">
                    <p>
                      • <strong>Workflow data:</strong> Your actual workflow
                      content and execution data never leaves your
                      infrastructure
                    </p>
                    <p>
                      • <strong>Credentials:</strong> API keys, passwords, and
                      authentication tokens are encrypted and never accessible
                      to us
                    </p>
                    <p>
                      • <strong>Business data:</strong> Customer data, financial
                      information, or any sensitive business information
                    </p>
                    <p>
                      • <strong>Personal files:</strong> Documents, images, or
                      files processed through your workflows
                    </p>
                  </div>
                </div>
              </div>
              ...
              {[
                {
                  ...
                  description:
                    "Request a complete copy of all personal data we have about you.",
                ...
                },
                {
                  ...
                  description:
                    "Export your data in a machine-readable format to take elsewhere.",
                  action: "Export Data",
                },
                {
                  title: "Restrict Processing",
                  description:
                    "Limit how we process your personal data for specific purposes.",
          ...
          <div className="max-w-4xl mx-auto">
            ...
            <div className="bg-gray-50 rounded-xl p-8">
              ...
              <p className="text-gray-600 mb-6">
                ...
                function properly. These cannot be disabled as they are required
              ...
              <p className="text-gray-600 mb-6">
                ...
                you use our website. This helps us improve your experience. You
              ...
              <p className="text-gray-600 mb-6">
                We do not use third-party marketing or tracking cookies. Any
                marketing-related cookies are first-party and respect your
                privacy preferences.
              </p>
      ...
      <section className="py-16 bg-gradient-to-r from-blue-600 to-purple-600 text-white">
        <div className="container mx-auto px-6 text-center">
          ...
          <p className="text-xl mb-8 max-w-2xl mx-auto opacity-90">
            Experience powerful automation without compromising your privacy.
