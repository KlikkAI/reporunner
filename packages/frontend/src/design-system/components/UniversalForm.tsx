...
export const UniversalForm: React.FC<UniversalFormProps> = ({
  ...
  const handleSubmit = useCallback(async (e: React.FormEvent) => {
    ...
    try {
      ...
      const hasErrors = validationErrors.some(error => error) || Object.values(errors).some(error => error);
...
export const useFormBuilder = (
  ...
  const buildForm = useCallback((overrideProps?: Partial<UniversalFormProps>) => {
    return (
      <UniversalForm
