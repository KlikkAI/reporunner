...
export const ApiKeyListApiResponseSchema = ApiResponseSchema(
  z.array(ApiKeySchema)
)
export const MfaBackupCodesApiResponseSchema =
  ApiResponseSchema(MfaBackupCodesSchema)
...
export type SessionInfoApiResponse = z.infer<
  typeof SessionInfoApiResponseSchema
>
...
export type MfaBackupCodesApiResponse = z.infer<
  typeof MfaBackupCodesApiResponseSchema
>
