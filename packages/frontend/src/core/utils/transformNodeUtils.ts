      ...
      case 'selected':
        ...
        selectedFields.forEach(fieldPath => {
          if (NestedObjectUtils.hasNestedPath(inputData, fieldPath)) {
            NestedObjectUtils.setNestedValue(selectedData, fieldPath, NestedObjectUtils.getNestedValue(inputData, fieldPath))
          }
        })
        return selectedData
...
class ConfigurationValidator {
  static validateTransformConfiguration(parameters: any): { valid: boolean; errors: string[] } {
    const errors: string[] = []
