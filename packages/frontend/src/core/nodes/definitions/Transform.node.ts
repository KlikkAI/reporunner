            ...
            options: [
              {
                ...
                required: true,
                description:
                  "Name of the field to set (supports dot notation for nested objects)",
              ...
              // String Value Field
              {
                ...
                default: "",
                description:
                  "String value for the field (supports expressions)",
                displayOptions: {
                  show: {
                    type: ["stringValue"],
                  },
              ...
              // Number Value Field
              {
                ...
                default: 0,
                description:
                  "Numeric value for the field (supports expressions)",
                displayOptions: {
                  show: {
                    type: ["numberValue"],
                  },
              ...
              // Boolean Value Field
              {
                ...
                default: false,
                description:
                  "Boolean value for the field (supports expressions)",
                displayOptions: {
                  show: {
                    type: ["booleanValue"],
                  },
              ...
              // Array Value Field
              {
                ...
                default: "[]",
                description:
                  "Array value as JSON string (supports expressions)",
                displayOptions: {
                  show: {
                    type: ["arrayValue"],
                  },
              ...
              // Object Value Field
              {
                ...
                default: "{}",
                description:
                  "Object value as JSON string (supports expressions)",
                displayOptions: {
                  show: {
                    type: ["objectValue"],
                  },
              ...
              // Date Value Field
              {
                ...
                default: "",
                description:
                  "Date/time value (supports expressions and various date formats)",
                displayOptions: {
                  show: {
                    type: ["dateValue"],
                  },
        ...
        options: [
          {
            ...
            default: true,
            description:
              "Use dot notation to access nested object properties (e.g., user.name)",
          },
          {
          ...
          },
          {
            ...
            default: false,
            description:
              "Cache expression evaluation results for better performance",
          },
          {
