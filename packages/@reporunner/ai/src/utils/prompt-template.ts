...
export class PromptTemplate {
  ...
  partial(values: Record<string, string>): PromptTemplate {
    ...
    const newInputVariables = this.inputVariables.filter((v) => !(v in newPartialVariables));
...
export class ChatPromptTemplate {
  ...
  constructor(systemTemplate: string | undefined, humanTemplate: string, aiTemplate?: string) {
    this.systemTemplate = systemTemplate ? PromptTemplate.fromTemplate(systemTemplate) : undefined;
    this.humanTemplate = PromptTemplate.fromTemplate(humanTemplate);
    this.aiTemplate = aiTemplate ? PromptTemplate.fromTemplate(aiTemplate) : undefined;
  }
